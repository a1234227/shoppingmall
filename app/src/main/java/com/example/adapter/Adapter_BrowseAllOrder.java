...
public class Adapter_BrowseAllOrder extends RecyclerView.Adapter<Adapter_BrowseAllOrder.myViewHolder> {
    ...
    public Adapter_BrowseAllOrder(AppCompatActivity c) {
...
//        path = LoginActivity.SERVER_ADDRESS + "customer_query?value=get_order_list&ids="+json;
    ...
    @NonNull
    @Override
    public Adapter_BrowseAllOrder.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_BrowseAllOrder.myViewHolder vh, int position) {
