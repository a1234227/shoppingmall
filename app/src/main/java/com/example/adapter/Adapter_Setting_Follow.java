...
public class Adapter_Setting_Follow extends RecyclerView.Adapter<Adapter_Setting_Follow.myViewHolder> {
    ...
    public Adapter_Setting_Follow(AppCompatActivity c) {
...
//        path = LoginActivity.SERVER_ADDRESS + "customer_query?value=get_order_list&ids="+json;
    ...
    @NonNull
    @Override
    public Adapter_Setting_Follow.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_Setting_Follow.myViewHolder vh, int position) {
